...
^Numpad1::
SendInput,{F8}ro [СБ МВД] ОСН "БАРС" начал спецоперацию по отлову ООП.{Enter}{F8}
Return

^Numpad2::
SendInput,{F8}ro [СБ МВД] ОСН "БАРС" продолжает спецоперацию по отлову ООП.{Enter}{F8}
Return

^Numpad3::
SendInput,{F8}ro [СБ МВД] ОСН "БАРС" закончил спецоперацию по отлову ООП. Потерь нет.{Enter}{F8}
Return