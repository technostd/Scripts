5x225x225x225x225x225x225x225x225x225x225x225x225x225
Подписчики180
Тимофей Синявский.
Тимофей
Александр Соколин.
...
AHK Province
три минуты назад
📢 АХК для ГИБДД #5 (0.1.0) (30.05.2021)

⚠ ВАЖНО ЗНАТЬ:
Данный АХК не бесплатный, его цена 80.000 игровых рублей, для того, чтобы получить доступ к нему, вам нужно:
1) Скачать АХК по ссылкам ниже
2) Запустить его и скопировать значения
3) Отправить скопированные значения либо в ЛС группы либо в мне в ЛС (там есть кнопка)
4) Ожидать ответа
нвойнвойнвойнвойнвой, Основное, Основное, ОсновноеEditPostEditPostEditPostGui 2:Add, Button, , Сохранитьx005 x005 x005 x005 ^end::
	ExitApp
Return
...
!`::
SendInput,{F8}do Планшет "РоМОС" в кармане.{Enter}{F8}
Sleep 500
SendInput,{F8}me достал и включил планшет{Enter}{F8}
Sleep 500
SendInput,{F8}do Планшет "РоМОС" готов к работе.{Enter}{F8}
Return

^`::
SendInput,{F8}me выключил планшет и убрал в карман{Enter}{F8}
Sleep 500
SendInput,{F8}do Планшет "РоМОС" в кармане.{Enter}{F8}
Return
...
Sleep 500
SendInput,{F8}say Здравия желаю, Подполковник полиции Загорецкий, сотрудник ГУ МВД по г. Мирный.{Enter}{F8}
Return
...
Sleep 500
SendInput,{F8}do [Удостоверение] СО-16 | Загорецкий Артём Сергеевич | Подполковник | ВрИО Командир ОСН "БАРС" [ГУ МВД по г. Мирный и МО].{Enter}{F8}
Sleep 500
...
Sleep 10
SendInput,{F8}do СПС "Гюрза" готов к стрельбе.{Enter}{F8}
Return

^'::
SendInput,{F8}me поставил пистолет на предохранитель и убрал его в кобуру{Enter}{F8}
Sleep 10
SendInput,{F8}do СПС "Гюрза" лежит в кобуре.{Enter}{F8}
Return
